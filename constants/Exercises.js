...
export default [
	{
		...
		exercises: [
			...
			{
				title: 'Half One-Arm Push-Up',
				img: images.pushup_step8,
				mastery: {
					beginner: [1, 5],
					intermediate: [2, 10],
					master: [2, 20],
	...
	},
	{
		title: 'Pull-Ups',
		exercises: [
			{ title: 'Vertical Pull', img: images.pullup_step1 },
			{ title: 'Horizontal Pull', img: images.pullup_step2 },
			{ title: 'Jacknife Pull', img: images.pullup_step3 },
			{ title: 'Half Pull-Up', img: images.pullup_step4 },
			{ title: 'Full Pull-Up', img: images.pullup_step5 },
			{ title: 'Close Pull-Up', img: images.pullup_step6 },
			{ title: 'Uneven Pull-Up', img: images.pullup_step7 },
			{ title: 'Half One-Arm Pull-Up', img: images.pullup_step8 },
			{ title: 'Assisted Pull-Up', img: images.pullup_step9 },
			{ title: 'One-Arm Pull-Up', img: images.pullup_step10 },
		],
	...
	},
	{
		title: 'Squats',
		exercises: [
			{ title: 'Shoulderstand Squat', img: images.squat_step1 },
			{ title: 'Jacknife Squat', img: images.squat_step2 },
			{ title: 'Supported Squat', img: images.squat_step3 },
			{ title: 'Half Squat', img: images.squat_step4 },
			{ title: 'Full Squat', img: images.squat_step5 },
			{ title: 'Close Squat', img: images.squat_step6 },
			{ title: 'Uneven Squat', img: images.squat_step7 },
			{ title: 'Half One-Leg Squat', img: images.squat_step8 },
			{ title: 'Assisted One-Leg Squat', img: images.squat_step9 },
			{ title: 'One-Leg Squat', img: images.squat_step10 },
		],
